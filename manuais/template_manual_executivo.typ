...
// Estilo de blocos de codigo — tamanho reduzido (6.8pt) porque os diagramas
// ASCII deste manual tem linhas de ate ~98 colunas; no corpo a 11.5pt elas
// estourariam a largura util da pagina (14.7cm) e quebrariam a formatacao
// alinhada por espacos do diagrama.
#show raw.where(block: true): it => block(
  width: 100%,
  fill: rgb("#f1f5f9"),
  inset: 6pt,
  radius: 4pt,
)[#set text(fill: rgb("#0f172a"), size: 6.8pt); #it]
...
// ── CAPA ────────────────────────────────────────────────────────────
  ...
  page(fill: bg-radial, margin: 0cm, header: none, footer: none, numbering: none)[
    ...
    // Logo superior removido nesta variante (manual executivo já usa a marca
    // em destaque no bloco central via imagem_produto — evita logo duplicado).
...
// Sem #pagebreak() aqui: o primeiro heading nivel 1 do corpo ja dispara sua
// propria quebra de pagina (show rule abaixo) — manter os dois causava uma
// pagina em branco entre o Sumario e a primeira secao real.
